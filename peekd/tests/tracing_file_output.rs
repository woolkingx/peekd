...
fn tracing_writes_to_file() {
    ...
    tracing::info!("attached fexit/sock_sendmsg_ret");
    ...
    assert!(content.contains("attached fexit/sock_sendmsg_ret"),
        "log should contain info message, got: {}", content);
    assert!(content.contains("libc not found"),
        "log should contain warn message, got: {}", content);
    assert!(content.contains("storage flush failed"),
        "log should contain error message, got: {}", content);
    assert!(content.contains("INFO"),
        "log should contain INFO level, got: {}", content);
    assert!(content.contains("WARN"),
        "log should contain WARN level, got: {}", content);
    assert!(content.contains("ERROR"),
        "log should contain ERROR level, got: {}", content);
